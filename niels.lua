...
io.popen("cd library && wget https://raw.githubusercontent.com/NIELS-TEAM/NIELS/main/library/redis.lua") 
...
if hash or SudoBot(msg) or DevNIELSW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevNIELSW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevNIELSW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevNIELSW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevNIELSW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevNIELSW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevNIELSW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "link_niels")
...
local NIELS_Msg = ''  
if msgs < 100 then 
NIELS_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
NIELS_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
NIELS_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
NIELS_Msg = 'متفاعل' 
elseif msgs < 1200 then 
NIELS_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
NIELS_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
NIELS_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
NIELS_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
NIELS_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
NIELS_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
NIELS_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
NIELS_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
NIELS_Msg = 'رب التفاعل'  
end 
return NIELS_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceNIELS(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."NIELS1:List:Filter"..sl)
...
if not DevNIELSW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevNIELSW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,NIELS_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ⌯' and DevNIELSW(msg) then  
...
if text == 'تعطيل التواصل ⌯' and DevNIELSW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌯' and DevNIELSW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌯' and DevNIELSW(msg) then  
...
if text == 'ضع كليشه ستارت ⌯' and DevNIELSW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌯︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌯' and DevNIELSW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌯' and DevNIELSW(msg) then 
...
os.execute('wget https://raw.githubusercontent.com/NIELS-TEAM/NIELS/main/NIELS.lua')
send(msg.chat_id_, msg.id_,' *⌯︙تم تحديث السورس* \n*⌯︙لديك اخر اصدار لسورس نيلز*\n*⌯︙الاصدار » { 2.8v}*')
dofile('NIELS.lua')  
end
if text == 'الاصدار ⌯' and DevNIELSW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙اصدار سورس نيلز* \n*⌯︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ⌯' and DevNIELSW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌯︙[تحديثات البوت](t.me/link_niels) \n⌯︙[قناه السورس](t.me/link_niels)')
end
if text == "ضع اسم للبوت ⌯" and DevNIELSW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌯' and DevNIELSW(msg) then 
...
if text == 'المشتركين ⌯' and DevNIELSW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌯' and DevNIELSW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text=="اذاعه خاص ⌯" and msg.reply_to_message_id_ == 0 and DevNIELSW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌯" and msg.reply_to_message_id_ == 0 and DevNIELSW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌯" and msg.reply_to_message_id_ == 0 and DevNIELSW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌯" and msg.reply_to_message_id_ == 0  and DevNIELSW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌯" and msg.reply_to_message_id_ == 0  and DevNIELSW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌯︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌯' and DevNIELSW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌯" and DevNIELSW(msg) then
...
if text == "تنظيف الكروبات ⌯" and DevNIELSW(msg) then 
...
send(msg.chat_id_, msg.id_,'*⌯︙عدد الكروبات الان » { '..#group..' }'..NIELSk..''..NIELS..'*\n*⌯︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevNIELSW(msg) then
...
usertext = '*\n ⌯︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'link_niels')..')'
status  = '\n *⌯︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevNIELSW(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌯︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'link_niels')..')'
status  = '\n*⌯︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevNIELSW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevNIELSW(msg) then
...
local NIELS1_Msg = database:get(bot_id.."NIELS1:Add:Filter:Rp2"..text..msg.chat_id_)   
if NIELS1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'link_niels')..') \n ⌯︙'..NIELS1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if NIELS_Msg and not Special(msg) then  
local NIELS_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if NIELS_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..NIELS_Msg.."] \n")
else
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/link_niels)}\n⌯︙["..NIELS_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *⌯︙عذرا ↫* {["..data.first_name_.."](T.ME/link_niels)}\n*⌯︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevNIELSW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevNIELSW(msg) then
...
if text and text:match("^تغير رساله الاشتراك$") and DevNIELSW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌯" and DevNIELSW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌯︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌯$") and DevNIELSW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌯" and DevNIELSW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ⌯" and DevNIELSW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌯︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌯" and DevNIELSW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."NIELS:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."NIELS:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_NIELS = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_NIELS then 
names_NIELS = database:smembers(bot_id.."NIELS:blocname"..msg.chat_id_) or ""
if names_NIELS and names_NIELS[1] then 
for i=1,#names_NIELS do 
if name_NIELS:match("(.*)("..names_NIELS[i]..")(.*)") then 
...
database:set(bot_id.."NIELS:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."NIELS:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."NIELS:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."NIELS:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."NIELS:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_NIELSa_new(NIELS1,NIELS2)
if NIELS2 and NIELS2.first_name_ then 
if NIELS2.first_name_:match("(.*)"..database:get(bot_id.."NIELS:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."NIELS:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local NIELS_nnn = database:get(bot_id.."NIELS:nump"..msg.chat_id_) or 5
local NIELS_nnn2 = database:get(bot_id.."NIELS:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(NIELS_nnn2) == tonumber(NIELS_nnn) or tonumber(NIELS_nnn2) > tonumber(NIELS_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."NIELS:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯︙عزيزي >>["..NIELS2.username_.."](https://t.me/"..(NIELS2.username_ or "link_niels")..")\n⌯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."NIELS:teh"..msg.chat_id_).."} بجانب اسمك\n⌯︙عدد المحاولات المتبقيه {"..(tonumber(NIELS_nnn) - tonumber(NIELS_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_NIELSa_new)
end
end
...
local NIELSChengName = database:get(bot_id.."NIELS:Cheng:Name"..data.id_)
if not data.first_name_ then 
if NIELSChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..NIELSChengName..']')
database:del(bot_id.."NIELS:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if NIELSChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."NIELS:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local NIELSChengUserName = database:get(bot_id.."NIELS:Cheng:UserName"..data.id_)
if not data.username_ then 
if NIELSChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..NIELSChengUserName..']')
database:del(bot_id.."NIELS:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if NIELSChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."NIELS:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local NIELSChengPhoto = database:get(bot_id.."NIELS:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if NIELSChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."NIELS:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if NIELSChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."NIELS:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevNIELSW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
send(msg.chat_id_, msg.id_, '*⌯︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'link_niels')..') \n*⌯︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'link_niels')..') \n*⌯︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevNIELSW(msg) then  
function start_function(extra, result, success)
if NIELSSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevNIELSW(msg) then  
...
if NIELSSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevNIELSW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if NIELSSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevNIELSW(msg) then  
function start_function(extra, result, success)
if NIELSSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevNIELSW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevNIELSW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if NIELSSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevNIELSW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevNIELSW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevNIELSW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevNIELSW(msg) then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevNIELSW(msg) then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevNIELSW(msg) then
...
if text == "مسح الملفات" and DevNIELSW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌯︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevNIELSW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevNIELSW(msg) then  
function start_function(extra, result, success)
...
local UserName = (b.username_ or "link_niels")
...
function Function_NIELS(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_NIELS, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_NIELS, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'link_niels')..')'
status  = '\n*⌯︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌯︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'link_niels')..')'
status  = '\n*⌯︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⌯︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'link_niels')..')'
...
database:set(bot_id.."NIELS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."NIELS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *⌯︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."NIELS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."NIELS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."NIELS1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."NIELS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *⌯︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."NIELS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."NIELS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."NIELS1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."NIELS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *⌯︙ارسل الكلمه الان*")  
database:set(bot_id.."NIELS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."NIELS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."NIELS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."NIELS1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."NIELS1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."NIELS1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."NIELS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."NIELS1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."NIELS1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevNIELSW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌯︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevNIELSW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⌯︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'link_niels')..')'..'\n*⌯︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevNIELSW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevNIELSW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'نيلز').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'نيلز')
local NIELS_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..NIELS_Msg[math.random(#NIELS_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevNIELSW(msg) then 
...
if NIELSSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevNIELSW(msg) then 
...
if text == 'اضف رد للكل' and DevNIELSW(msg) then    
send(msg.chat_id_, msg.id_,' *⌯︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevNIELSW(msg) then    
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'نيلز').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevNIELSW(msg) then   
...
if text == 'تعطيل المغادره' and DevNIELSW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'link_niels')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
NIELSdx(msg.chat_id_, msg.id_, ' *⌯︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*⌯︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*⌯︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*⌯︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevNIELSW(msg) then
...
{{text = 'NIELS 𝑇𝐸𝐴𝑀', url="t.me/link_niels"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
gk = https.request('https://vvvzvv.ml/amirBrg/NIELS.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://vvvzvv.ml/amirOmr/NIELS.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
data,res = https.request('https://vvvzvv.ml/amirVois/NIELS.php')
if res == 200 then
...
inline = {
{{text = 'sᴏᴜʀᴄʀ NIELS',url='http://t.me/link_niels'}},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'نيلز')
...
NIELS = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(NIELS)
...
--------------------------------------------------------------------------------------------------------------
SourceNIELS(data.message_,data)
...
------------------------------------------------------------------------
local s8sbot = database:get(bot_id.."NIELS1:Add:Filter:Rp2"..text..result.chat_id_)   
if s8sbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..s8sbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local NIELS1_Msg = database:get(bot_id.."NIELS1:Add:Filter:Rp2"..text..result.chat_id_)   
if NIELS1_Msg then
send(msg.chat_id_, msg.id_," ⌯︙"..NIELS1_Msg)
